...
#quote(attribution: [Thomas Kuhn, The Copernican Revolution])["...Copernicus' aesthetic objections to [equants] provided one essential motive for his rejection of the Ptolemaic system...."]

#quote(attribution: [Ben Rich, Skunk Works])["All of us had been trained by Kelly Johnson and believed fanatically in his insistence that an airplane that looked beautiful would fly the same way."]

#quote(attribution: [G. H. Hardy, A Mathematician's Apology])["Beauty is the first test: there is no permanent place in this world for ugly mathematics."]

I was talking recently to a friend who teaches at MIT. His field is hot now and every year he is inundated by applications from would-be graduate students. _"A lot of them seem smart,"_ he said. _"What I can't tell is whether they have any kind of taste."_
...
I'm not sure why. It may just be my own stupidity. A can-opener must seem miraculous to a dog. Maybe if I were smart enough it would seem the most natural thing in the world that $e^(i dot pi) = -1$. It is after all necessarily true.
...
Intolerance for ugliness is not in itself enough. You have to understand a field well before you develop a good nose for what needs fixing. You have to do your homework. But as you become expert in a field, you'll start to hear little voices saying, _What a hack! There must be a better way_. Don't ignore those voices.  Cultivate them. The recipe for great work is: very exacting taste, plus the ability to gratify it.
